...
TIMKU77="10"
IDDKU77="661713693"
KEYKU77="6765354515:AA2pAUrVvjgJmQQySIrwkc3bmi7t3QEc"
...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m                GRAD TUNNELING               \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Grad412009/backend/main/ipqu | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Grad412009/backend/main/ipqu | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
clear
clear
REPO="https://raw.githubusercontent.com/Grad412009/Grad/main/"
start=$(date +%s)
secs_to_human() {
...
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Grad412009/backend/main/ipqu | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Grad412009/backend/main/ipqu | grep $ipsaya | awk '{print $3}')
...
wget "http://raw.githubusercontent.com/Grad412009/Grad/main/files/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
wget https://raw.githubusercontent.com/Grad412009/Grad/main/files/openvpn &&  chmod +x openvpn && ./openvpn
...
wget https://raw.githubusercontent.com/Grad412009/Grad/main/Features/menu.zip
unzip menu.zip
chmod +x menu/*
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m             ----[ GRAD TUNNEL ]----                    \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
